...
var $author$project$Main$Ranking = function (first) {
	return function (second) {
		return function (third) {
			return function (fourth) {
				return function (fifth) {
					return function (sixth) {
						return function (seventh) {
							return function (eighth) {
								return function (ninth) {
									return function (tenth) {
										return {eighth: eighth, fifth: fifth, first: first, fourth: fourth, ninth: ninth, second: second, seventh: seventh, sixth: sixth, tenth: tenth, third: third};
									};
								};
							};
						};
...
var $author$project$Main$rankingDecoder = A3(
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'first',
										$elm$json$Json$Decode$string,
										$elm$json$Json$Decode$succeed($author$project$Main$Ranking)))))))))));
					...
					$elm$http$Http$post(
						{
							body: $elm$http$Http$multipartBody(
								_List_fromArray(
									[
										A2($elm$http$Http$stringPart, 'sentence', model.input)
									])),
							expect: A2($elm$http$Http$expectJson, $author$project$Main$Receive, $author$project$Main$rankingDecoder),
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state: $author$project$Main$Loaded(ranking)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state: $author$project$Main$Failed(e)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
